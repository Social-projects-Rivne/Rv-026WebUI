...
db.query(`INSERT INTO ingredients (name, is_deleted, photo) VALUES ('Чай','FALSE', 'http://provitaminki.com/wp-content/uploads/2015/05/81_20052-300x240.jpg');`,
(err, res) => {
  if (err) {console.log(err)}
  else {console.log(res)}
});
...
db.query(`INSERT INTO recipe_tag (resipe_id, tag_id) VALUES (10,1), (10,2), (20,3), (20,6), (30,5), (30,6)`,
(err, res) => {
  if (err) {console.log(err)}
  else {console.log(res)}
});
