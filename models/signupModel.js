...
signupModel.upsertIntoUsers = (email, phone, password, activationId) =>
    `INSERT INTO users (email, phone_number, password, is_activated, activation_id) VALUES ('${email}', '${phone}', '${password}', FALSE, '${activationId}') ON CONFLICT (email) DO UPDATE SET phone_number = '${phone}', password = '${password}', activation_id='${activationId}'`;
